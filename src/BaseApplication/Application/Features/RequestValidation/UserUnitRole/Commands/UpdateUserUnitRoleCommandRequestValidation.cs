...
{
    public class UpdateUserUnitRoleCommandRequestValidation : AbstractValidator<UpdateUserUnitRoleCommandRequest>
    {
        public UpdateUserUnitRoleCommandRequestValidation()
        {
